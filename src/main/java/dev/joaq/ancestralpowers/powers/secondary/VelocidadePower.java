...
public class VelocidadePower implements Power {
    ...
    public void apply(ServerPlayerEntity player, boolean activate, float stamina) {
        ...
        addModifier(movementSpeedAttr, MOVEMENT_SPEED_ID, 0.2);
        addModifier(attackSpeedAttr, ATTACK_SPEED_ID, 2.0);
        addModifier(submergedSpeedAttr, SUBMERGED_SPEED_ID, 0.5);
        addModifier(blockSpeedAttr, BLOCK_SPEED_ID, 1.0);
        addModifier(sneakingSpeedAttr, SNEAKING_SPEED_ID, 0.3);
    }
